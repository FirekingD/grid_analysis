...
iris_paris_joined_conso2018<-filter(iris_paris_joined_conso,Ann�e=="2018")
iris_paris_joined_conso2019<-filter(iris_paris_joined_conso,Ann�e=="2019")
iris_paris_joined_conso2020<-filter(iris_paris_joined_conso,Ann�e=="2020")
